...
<form id="formAdulto">
    ...
    <div class="row">
        <div class="mb-3 col-md-6 d-flex column-gap ">
            <label class="form-label">¿Posee alguna enfermedad cardiológica, neurológica o de vías
                respiratorias?</label>
    ...
    <div class="row">
        <div class="mb-3 col-md-6 d-flex column-gap ">
            ...
            <div class="form-check">
                <input class="form-check-input" type="radio" id="servicioMedicoSi" name="medicoPrivadoPublico"
                    value="1">
                <label class="form-check-label" for="servicioMedicoSi">Sí</label>
            </div>
            <div class="form-check">
                <input class="form-check-input" type="radio" id="servicioMedicoNo" name="medicoPrivadoPublico"
                    value="0">
            ...
            <tbody id="tablaServicios">
                ...
                <tr>
                    ...
                    <td><input type="text" id="servicio_water_spinning_martes" name="servicio_water_spinning_martes"
                            class="form-control"></td>
                    <td><input type="text" id="servicio_water_spinning_miercoles"
                            name="servicio_water_spinning_miercoles" class="form-control"></td>
                ...
                <tr>
                    ...
                    <td><input type="text" id="servicio_rehabilitacion_martes" name="servicio_rehabilitacion_martes"
                            class="form-control"></td>
                    <td><input type="text" id="servicio_rehabilitacion_miercoles"
                            name="servicio_rehabilitacion_miercoles" class="form-control"></td>
                ...
                <tr>
                    <td>Aqua Yoga</td>
                    <td><input type="text" id="servicio_aqua_yoga_lunes" name="servicio_aqua_yoga_lunes"
                            class="form-control">
                    </td>
