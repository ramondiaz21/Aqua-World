  ...
  for (var i = 0; i < data.length; i++) {
    ...
    for (var j = 0; j < indices; j++) {
      if (j == indices - 1)
        if (data[i][j] == "Activo")
          tbody +=
            '<td><button type="button" class="btn btn-success btn-xs">&nbsp&nbsp&nbsp' +
            data[i][j] +
            "&nbsp&nbsp&nbsp</button></td>";
        else
          tbody +=
            '<td><button type="button" class="btn btn-danger btn-xs">&nbsp&nbsp&nbsp' +
            data[i][j] +
            "&nbsp&nbsp&nbsp</button></td>";
    ...
    if (data[i][data[i].length - 1] == "Activo") {
      tbody +=
        ...
        "(" +
        data[i][0] +
        ')" class="btn btn-info btn-xs" data-target="#modEditar" data-toggle="modal">' +
